<template>
  <div class="min-h-screen flex flex-col bg-slate-900 lg:flex-row">
    ...
    <div class="relative flex w-full min-h-[40vh] overflow-hidden lg:w-1/2 lg:min-h-screen">
      ...
      <div
        class="relative z-10 flex min-h-full w-full flex-col items-center justify-center gap-6 px-8 py-16 text-center text-white lg:items-start lg:px-16 lg:text-left"
      >
        <div class="max-w-3xl">
          <h1
    ...
    <!-- Form Section -->
    <div
      class="flex w-full items-center justify-center bg-white px-6 py-12 shadow-2xl lg:w-1/2 lg:min-h-screen lg:px-12"
    >
      <div class="w-full max-w-[420px] opacity-0 animate-slideInRight">
        <!-- Logo Header -->
        <div
          class="flex justify-center items-center mb-10 py-6 rounded-2xl border border-[#40DEFF]/10 relative overflow-hidden"
          style="
        ...
        >
          <div
            class="absolute inset-0 z-[-1] opacity-60 animate-logoGlow"
            style="
            ...
            <transition name="form-slide" mode="out-in">
              ...
              <div v-if="!showForgotPassword" key="login-form" class="flex flex-col gap-6">
                ...
                <div class="flex flex-col gap-2">
                  <div class="relative">
                    <input
                      ...
                      :class="{
                        ...
                        'border-green-500 shadow-[0_0_0_2px_rgba(16,185,129,0.1)]':
                          !emailError && credentials.email && credentials.email.length > 0,
                        'border-gray-300':
                          !emailError && (!credentials.email || credentials.email.length === 0),
                      }"
                    ...
                    <label
                      ...
                      :class="{
                        'top-[-0.6rem] left-3 text-xs font-semibold text-[#40DEFF] bg-white px-2 rounded-md backdrop-blur-sm shadow-[0_2px_8px_rgba(0,0,0,0.1)]':
                          credentials.email || emailFocused,
                  ...
                  <div
                    v-if="emailError && credentials.email"
                    class="text-xs text-red-500 mt-2 ml-3 flex items-center gap-1 animate-slideUp"
                  >
                ...
                <div class="flex flex-col gap-2">
                  <div class="relative mt-2">
                    ...
                    <label
                      ...
                      :class="{
                        'top-[-0.6rem] left-3 text-xs font-semibold text-[#40DEFF] bg-white px-2 rounded-md backdrop-blur-sm shadow-[0_2px_8px_rgba(0,0,0,0.1)]':
                          credentials.password || passwordFocused,
                    ...
                    <div
                      class="absolute right-3 top-1/2 -translate-y-1/2 flex items-center gap-2 z-10"
                    >
                      <button
                        type="button"
                  ...
                  <div class="flex justify-center">
                    <button
                      ...
                      :class="{
                        ...
                        'bg-[#245FE7] text-white cursor-pointer shadow-[0_4px_15px_rgba(36,95,231,0.3)] hover:-translate-y-0.5 hover:shadow-[0_8px_25px_rgba(36,95,231,0.4)] hover:bg-[#1E4ED8] active:translate-y-0 active:shadow-[0_2px_10px_rgba(36,95,231,0.3)]':
                          isFormValid && !isLoading,
                      }"
                      :aria-label="isLoading ? 'Iniciando sesión...' : 'Iniciar Sesión'"
                    >
                      <span v-if="!isLoading" class="transition-opacity duration-200"
                        >Iniciar Sesión</span
                      >
              ...
              <div v-else key="forgot-form" class="flex flex-col gap-6">
                ...
                <div v-if="!forgotPasswordSuccess">
                  ...
                  <div class="flex flex-col gap-3 mt-4">
                    <div class="flex justify-between items-center gap-4">
                      ...
                      >
                        <span v-if="!forgotPasswordLoading" class="transition-opacity duration-200"
                          >Enviar</span
                        >
                        <div v-else class="flex items-center gap-2">
                          <div
                ...
                <div v-else class="text-center py-6">
                  <div
                    class="w-20 h-20 bg-gradient-to-br from-green-500 to-green-600 rounded-full flex items-center justify-center mx-auto mb-6 animate-successPulse"
                  >
        ...
        <div
          ...
          class="bg-gradient-to-br from-red-50 to-red-100 border border-red-200 text-red-600 py-3 px-4 rounded-xl text-sm mt-4 flex items-center gap-2 shadow-[0_4px_12px_rgba(239,68,68,0.15)] animate-shake"
        >
        ...
        <div
          v-if="successMessage"
          class="bg-gradient-to-br from-green-50 to-green-100 border border-green-200 text-green-700 py-3 px-4 rounded-xl text-sm mt-4 flex items-center gap-2 shadow-[0_4px_12px_rgba(16,185,129,0.15)] opacity-0 animate-fadeIn"
        >
