    ...
    <div class="main-content" :class="{ 'with-header': true }">
      <div class="dynamic-container">
        <div class="view-header">
          <h1 class="view-title">
            <i :class="menuIcon || 'fas fas fa-circle-outline'"></i>
            {{ menuTitle || 'Vista Dinámica' }}
          </h1>
          <p class="view-subtitle">Esta es una vista generada automáticamente</p>
        </div>
        ...
        <div class="content-section">
          <div class="info-card">
            ...
            <div class="card-content">
              <p>
                Esta vista ha sido creada automáticamente por el sistema de gestión de menús. Puedes
                personalizar este contenido según tus necesidades.
              </p>
